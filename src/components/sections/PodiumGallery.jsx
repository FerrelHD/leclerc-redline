...
export default function PodiumGallery() {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.to(trackRef.current, {
        ...
        scrollTrigger: {
          ...
          // Pin aktif sejak awal di top, tapi beri jeda scroll agar About terangkat dulu
          start: 'top top',
          end: () => `+=${window.innerHeight + Math.round(getScrollDistance() * 0.65)}`,
          pin: true,
          pinSpacing: true,
          scrub: 0.5,
  ...
  return (
    <section
      id="podiums"
      ref={sectionRef}
      className="relative bg-[#F8F9FA] text-[#0A0A0B] z-10 w-full h-screen overflow-hidden flex flex-col justify-center select-none -mt-[100vh]"
    >
      ...
      >
        ...
        <div className="w-[35vw] sm:w-[40vw] lg:w-[45vw] h-full shrink-0 flex items-center justify-start pl-8 sm:pl-16 md:pl-24 pointer-events-none select-none">
