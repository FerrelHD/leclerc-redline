...
export default function MenuOverlay({ isOpen, onClose }) {
  ...
  // Silky smooth SVG Morphing Curved Curtain
  const curveVariants = {
    initial: {
    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[9999] select-none">
          ...
          {/* 1. SOLID FERRARI RED DEEP ROUNDED BOWL SVG CURTAIN (Zero Glow, 100% Solid Red) */}
          <svg
          ...
          {/* 2. MENU CONTENT CONTAINER ON SOLID RED */}
          <motion.div
          ...
          >
            ...
            <div className="relative z-10 w-full flex items-center justify-between">
              {/* Left: Brand Monogram with Black Box Reveal on Red Canvas */}
              <div className="flex flex-col">
                <TextBoxReveal delay={0.4} boxColor="#000000">
                  <span className="font-editorial text-2xl md:text-3xl tracking-tight leading-none text-white font-medium">
                    CHARLES
                  </span>
                </TextBoxReveal>
                <TextBoxReveal delay={0.48} boxColor="#000000">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto my-auto py-6 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
              ...
              {/* RIGHT COLUMN: Giant Typography Menu with Black Box Reveal on Red Canvas */}
              <div className="lg:col-span-6 flex flex-col items-center lg:items-end justify-center text-center lg:text-right gap-6">
                ...
                <nav className="flex flex-col gap-2 md:gap-3">
                  {menuItems.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        <TextBoxReveal delay={0.42 + index * 0.08} boxColor="#000000">
                          <a
                            href={item.href}
                            onClick={() => {
                          ...
                          >
                            ...
                            {/* Crisp Solid White Wave Slash for Active Item */}
                            {isActive && (
                              <motion.div
                ...
                <div className="flex flex-col items-center lg:items-end mt-4 text-center lg:text-right">
                  <TextBoxReveal delay={0.82} boxColor="#000000">
            ...
            <div className="relative z-10 w-full flex flex-col md:flex-row items-center justify-between pt-6 border-t border-white/20 gap-4 text-xs font-racing uppercase tracking-wider text-white/80">
              <TextBoxReveal delay={0.88} boxColor="#000000">
                <a
              ...
              <div className="flex items-center gap-6">
                <TextBoxReveal delay={0.92} boxColor="#000000">
                ...
                <TextBoxReveal delay={0.96} boxColor="#000000">
                ...
                <TextBoxReveal delay={1.0} boxColor="#000000">
                ...
                <TextBoxReveal delay={1.04} boxColor="#000000">
