...
export default function MenuOverlay({ isOpen, onClose }) {
  ...
  // Deep Rounded Bowl SVG Morphing (Normalized 0-100 ViewBox with deep curve)
  // In Canva reference: The bottom edge arches way down into a deep circular bowl!
  const curveVariants = {
    initial: {
      d: "M 0 0 L 100 0 L 100 0 Q 50 85 0 0 Z",
    },
    animate: {
    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[9999] select-none">
          ...
          {/* 1. DEEP ROUNDED BOWL SVG CURTAIN (Overlaps from top with deep circular bowl) */}
          <svg
            className="fixed inset-0 w-full h-full pointer-events-none fill-[#09090b] z-[9998] filter drop-shadow-[0_25px_60px_rgba(225,6,0,0.5)]"
            viewBox="0 0 100 100"
          ...
          {/* 2. MENU CONTENT CONTAINER (Revealed cleanly inside the dark curtain) */}
          <motion.div
            variants={contentVariants}
            initial="initial"
            animate="animate"
            exit="exit"
            className="relative z-[9999] w-full h-full overflow-y-auto overflow-x-hidden flex flex-col justify-between p-6 md:p-12 text-[#f8f9fa]"
          >
            ...
            <div className="relative z-10 w-full flex items-center justify-between">
              ...
              <div className="flex flex-col">
                ...
                <TextBoxReveal delay={0.48} boxColor="#E10600">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto my-auto py-6 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
              ...
              <div className="lg:col-span-6 flex flex-col items-center lg:items-end justify-center text-center lg:text-right gap-6">
                ...
                <nav className="flex flex-col gap-2 md:gap-3">
                  {menuItems.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        <TextBoxReveal delay={0.45 + index * 0.1} boxColor="#E10600">
                          <a
                            href={item.href}
                            onClick={() => {
                ...
                <div className="flex flex-col items-center lg:items-end mt-4 text-center lg:text-right">
                  <TextBoxReveal delay={0.85} boxColor="#FFDE00">
            ...
            <div className="relative z-10 w-full flex flex-col md:flex-row items-center justify-between pt-6 border-t border-white/10 gap-4 text-xs font-racing uppercase tracking-wider text-neutral-400">
              ...
              <div className="flex items-center gap-6">
                ...
                <TextBoxReveal delay={1.0} boxColor="#E10600">
                ...
                <TextBoxReveal delay={1.05} boxColor="#E10600">
                ...
                <TextBoxReveal delay={1.1} boxColor="#E10600">
